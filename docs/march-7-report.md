...
> **Baseline Documents:** `docs/feb-9-report.md`, `docs/feb-9-plan.md`
...
- **A major iOS crash-isolation effort took place from late February into early March.**
  ...
  - By the current `docs/safe_mode_plan.md`, the app is now described as stable in full `src/app` boot with `NormalRoot`, sign-in flow, tabs, library detail, and game route.
