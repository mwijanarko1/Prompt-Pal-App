		...
		return (
			<View className="bg-surfaceVariant rounded-xl px-4 py-3 border border-outline">
				<View className="flex-row justify-between items-center">
					...
					<Text
						className={`text-sm font-bold ${getUsageColor(totalUsed, totalLimit)}`}
					>
		...
		<View className="bg-surfaceElevated rounded-2xl p-6 shadow-lg">
			...
			<View className="mb-4">
				<View className="flex-row justify-between items-center mb-2">
					...
					<Text
						className={`text-sm font-bold ${getUsageColor(usage.used.textCalls, usage.limits.textCalls)}`}
					>
				...
				<View className="bg-surfaceVariant rounded-full h-3 overflow-hidden">
					<View
						...
						style={{
							width: `${getProgressWidth(usage.used.textCalls, usage.limits.textCalls)}%`,
						}}
					/>
				</View>
			</View>
			...
			<View className="mb-4">
				<View className="flex-row justify-between items-center mb-2">
					...
					<Text
						className={`text-sm font-bold ${getUsageColor(usage.used.imageCalls, usage.limits.imageCalls)}`}
					>
				...
				<View className="bg-surfaceVariant rounded-full h-3 overflow-hidden">
					<View
						...
						style={{
							width: `${getProgressWidth(usage.used.imageCalls, usage.limits.imageCalls)}%`,
						}}
					/>
				</View>
			</View>
