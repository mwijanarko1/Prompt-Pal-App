	...
	const runActualCheck = async () => {
		...
		try {
			...
			if (!generatedCodeText.trim()) {
				throw new Error(
					"AI returned empty code. Try a more specific bug report.",
				);
			}
			...
			setFeedback({
				...
				text:
					feedbackLines[0] ||
					(passed ? "Nice work." : "Your bug report needs more detail."),
				nudge: passed
					? undefined
					: feedbackLines.join(" ") ||
						"Try stating what is broken and the expected behavior.",
			...
			logger.error("Practice3Screen.runActualCheck", error);
					...
					<View style={styles.content}>
						...
						>
							...
							<Text style={styles.instruction}>
								Fix the bugs while keeping everything else intact.
							</Text>
						</Animated.View>
							...
							<View style={styles.targetPreview}>
								...
								<View style={styles.mockInputContainer}>
									<View style={styles.mockInput}>
										<Text style={styles.mockInputPlaceholder}>New task...</Text>
									</View>
									<View style={styles.mockAddButton}>
										<Text style={styles.mockAddButtonText}>Add</Text>
									</View>
								</View>
									...
									<View style={styles.bugItem}>
										...
										<View style={styles.bugTextWrap}>
											<Text style={styles.bugText}>
												Clicking tasks does NOT cross them out.
											</Text>
										</View>
									</View>
									<View style={styles.bugItem}>
										...
										<View style={styles.bugTextWrap}>
											<Text style={styles.bugText}>
												The 'Add' button works even if the box is empty.
											</Text>
										</View>
									</View>
								</View>
								<Text style={styles.behaviorText}>
									Requirement: Fix both without changing anything else.
								</Text>
							</View>
							...
							{showHint && (
								...
								>
									<Text style={styles.hintText}>
										💡 Tell AI exactly what each bug is (no cross-out, empty
										input works) and what the correct behavior should be. Tell
										it what NOT to touch.
									</Text>
								</Animated.View>
							)}
						</Animated.View>
