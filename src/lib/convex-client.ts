...
async function wrapWithAuthRetry<T>(
...
client.query = ((...args: any[]) =>
	wrapWithAuthRetry(originalQuery, ...args)) as any;
client.mutation = ((...args: any[]) =>
	wrapWithAuthRetry(originalMutation, ...args)) as any;
client.action = ((...args: any[]) =>
	wrapWithAuthRetry(originalAction, ...args)) as any;
