...
describe("scaffold utils", () => {
	...
	it("rejects trivial slot input for checklist (under 3-char alnum runs)", () => {
	...
	it("ordinal checklist does not tick for short garbage in slots", () => {
		const template = "Hello [a] and [b]";
