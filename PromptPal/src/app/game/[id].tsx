    ...
    <View className="flex-1 bg-background">
      ...
      <ResultModal
        ...
        onNext={() => {
          ...
          const moduleId = level.moduleId || getModuleIdFromLevelType(level.type || 'image');
          const expectedType = moduleId === 'image-generation' ? 'image' : moduleId === 'coding-logic' ? 'code' : 'copywriting';
          ...
          const nextLevel = idx >= 0 && idx < sortedLevels.length - 1 ? sortedLevels[idx + 1] : null;
          if (nextLevel) {
