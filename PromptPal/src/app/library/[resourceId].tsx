			...
			<SafeAreaView className="flex-1 bg-background">
				...
				<View className="px-6 pt-4 pb-2">
					<View className="flex-row items-center">
						...
						<Text className="flex-1 text-center text-onSurface text-lg font-black uppercase tracking-[3px]">
							Resource
						</Text>
				...
				>
					<View className="px-6 pt-4">
						<Text className="text-onSurface text-3xl font-black mb-4">
							{resource.title}
						</Text>
					...
					<View className="px-6">{renderResourceContent(resource)}</View>
				</ScrollView>
			</SafeAreaView>
		</SubscriptionAccessGuard>
	);
