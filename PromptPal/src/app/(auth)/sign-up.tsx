					...
					>
						...
						<View className="mb-8 items-center">
							...
							<Text className="px-8 text-center text-sm leading-5 text-onSurfaceVariant">
								...
								<Text className="text-onSurface font-black tracking-normal">
									{emailAddress}
								</Text>
							</Text>
						</View>
						...
						<View className="mb-8 w-full self-center rounded-[28px] border border-outline/15 bg-surface px-6 py-7 shadow-2xl shadow-black/30">
							...
							<View className="mb-6">
								<Text className="mb-2 text-center text-[11px] font-bold uppercase tracking-[1.8px] text-onSurfaceVariant">
									Enter 6-digit code
								</Text>
								<View
								...
								{errors.code ? (
									<Text className="mt-2 text-center text-[11px] font-semibold text-error">
										{errors.code}
									</Text>
								) : null}
							</View>
				...
				>
					...
					<View className="mb-2 mt-4 flex-row items-center justify-center">
						...
						<Link href="/(auth)/sign-in" className="ml-2">
							<Text className="text-sm font-bold text-secondary">Sign In</Text>
						</Link>
					</View>
				</ScrollView>
			</KeyboardAvoidingView>
