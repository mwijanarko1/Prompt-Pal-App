...
const MODULES = [
    {
        ...
        description: 'Create images from prompts and learn visual prompt engineering',
        icon: 'image-outline' as const,
        color: '#03DAC6',
        gradient: 'rgba(3, 218, 198, 0.08)',
    ...
    return (
        <OnboardingScreenWrapper>
            ...
            >
                ...
                >
                    <Ionicons name="sparkles" size={16} color={ONBOARDING_COLORS.accentWarm} />
                    <Text style={styles.tipText}>
                        Each module teaches different prompt skills. Try them all to become a master!
                    </Text>
                </Animated.View>
