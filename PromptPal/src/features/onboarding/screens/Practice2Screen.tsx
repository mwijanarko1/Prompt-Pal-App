                ...
                >
                    ...
                    <Animated.View entering={FadeInDown.duration(600).delay(200)} style={styles.header}>
                        <Text style={styles.title}>Make it do something</Text>
                            <Text style={styles.instruction}>Add a way for users to add tasks to this list.</Text>
                        </Animated.View>
                        ...
                        <Animated.View entering={FadeInUp.duration(500).delay(400)} style={styles.codeContainer}>
                            ...
                            <View style={styles.targetPreview}>
                                ...
                                <Text style={styles.behaviorText}>Task: Add a way for the user to type and add new tasks to this list.</Text>
                            </View>
                            
                            {showHint && (
                                <Animated.View entering={FadeIn} exiting={FadeOut} style={styles.hintBox}>
                                    <Text style={styles.hintText}>
                                        💡 Think about what the user needs to type into, what they click, and where the new task shows up.
                                    </Text>
                                </Animated.View>
                            )}
                        </Animated.View>
                        ...
                        <Animated.View entering={FadeInUp.duration(500).delay(600)} style={styles.inputSection}>
                            ...
                            {isGenerating && (
                                <Animated.View entering={FadeIn} exiting={FadeOut} style={styles.loadingContainer}>
                                    <ActivityIndicator color={ONBOARDING_COLORS.info} size="large" />
                            ...
                            {generatedCode && !isGenerating && (
                                <Animated.View entering={FadeIn} style={styles.generatedCodeSection}>
                                    ...
                                    <View style={[styles.codeBox, { backgroundColor: 'rgba(65, 81, 255, 0.05)', borderColor: 'rgba(65, 81, 255, 0.2)' }]}>
                        ...
                        <Animated.View entering={FadeInUp.duration(500).delay(800)} style={styles.buttonContainer}>
                            ...
                            >
                                <Text style={styles.buttonText}>
                                    {isGenerating ? 'Analyzing...' : feedback?.success ? 'Next Lesson' : 'Test Logic'}
                                </Text>
                                {!isGenerating && (
                                    <Ionicons 
