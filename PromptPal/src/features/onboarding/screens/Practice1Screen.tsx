		...
		try {
			...
			setFeedback({
				...
				nudge: passed
					? undefined
					: feedbackLines.join(" ") ||
						"Try adding clearer behavior and guardrails.",
					...
					<View style={styles.content}>
						...
						>
							...
							<Text style={styles.instruction}>
								Recreate the button below using a prompt.
							</Text>
						</Animated.View>
						...
						>
							...
							<View style={styles.targetPreview}>
								...
								<Text style={styles.behaviorText}>
									Action: Shows "Hello!" alert when clicked
								</Text>
							</View>
							...
							{showHint && (
								...
								>
									<Text style={styles.hintText}>
										💡 Think about what the button should do, what it says, and
										what color it is.
									</Text>
								</Animated.View>
							)}
