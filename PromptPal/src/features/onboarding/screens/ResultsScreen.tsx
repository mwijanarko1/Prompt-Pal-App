...
export function ResultsScreen() {
	const { goToNextStep, addBadge, addXp, generatedCopy, score, copyFeedback } =
		useOnboardingStore();
	...
	const qualityLabel =
		displayScore >= 80 ? "EXPERT" : displayScore >= 60 ? "GOOD" : "LEARNING";
					...
					<View style={styles.resultCard}>
						...
						{generatedCopy ? (
							<View style={styles.generatedCopyBox}>
								<Text style={styles.generatedCopyLabel}>
						...
						>
							<View style={styles.breakdownRow}>
								...
								<Text style={styles.breakdownText}>
									Subject: <Text style={styles.boldText}>Identified</Text>
								</Text>
							</View>
							<View style={styles.breakdownRow}>
								<Ionicons
								...
								/>
								<Text style={styles.breakdownText}>
									Specificity: <Text style={styles.boldText}>Detailed</Text>
								</Text>
							</View>
							<View style={styles.breakdownRow}>
								<Ionicons
								...
								/>
								<Text style={styles.breakdownText}>
									Guardrail: <Text style={styles.boldText}>Protected</Text>
								</Text>
							</View>
						</Animated.View>
					)}
