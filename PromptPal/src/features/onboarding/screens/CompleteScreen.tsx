...
const BADGE_ICON_MAP: Record<string, { icon: keyof typeof Ionicons.glyphMap; label: string }> = {
    'prompt-apprentice': { icon: 'school-outline', label: 'Prompt Apprentice' },
    'onboarding-complete': { icon: 'trophy-outline', label: 'Onboarding Complete' },
...
export function CompleteScreen() {
    ...
    const earnedBadges = badges.length > 0 ? badges : ['prompt-apprentice', 'onboarding-complete'];
        ...
        <OnboardingScreenWrapper showProgress={false}>
            <View style={styles.container}>
                ...
                <Animated.View entering={ZoomIn.duration(600).delay(200)} style={styles.fireworksRow}>
                    ...
                    <Ionicons name="sparkles" size={28} color={ONBOARDING_COLORS.accent} />
                    <Ionicons name="star" size={24} color={ONBOARDING_COLORS.accentWarm} />
                </Animated.View>
                ...
                >
                    ...
                    <View style={styles.statsRow}>
                        <View style={styles.statItem}>
                            <Ionicons name="trophy-outline" size={22} color={ONBOARDING_COLORS.accentWarm} style={{ marginBottom: 6 }} />
                            <Text style={styles.statValue}>Level 1</Text>
                            <Text style={styles.statLabel}>Achieved</Text>
                        </View>
                        <View style={styles.statDivider} />
                        <View style={styles.statItem}>
                            <Ionicons name="star-outline" size={22} color={ONBOARDING_COLORS.accentWarm} style={{ marginBottom: 6 }} />
                            <Text style={styles.statValue}>{xpEarned || 100}</Text>
                            <Text style={styles.statLabel}>XP Earned</Text>
                        </View>
                        <View style={styles.statDivider} />
                        <View style={styles.statItem}>
                            <Ionicons name="flame-outline" size={22} color={ONBOARDING_COLORS.accent} style={{ marginBottom: 6 }} />
                ...
                >
                    ...
                    <View style={styles.badgesRow}>
                        {earnedBadges.map((badgeId) => {
                            ...
                            return (
                                <View key={badgeId} style={styles.badgeChip} accessibilityLabel={badge.label}>
                                    <Ionicons name={badge.icon} size={18} color={ONBOARDING_COLORS.accentWarm} />
                                </View>
                            );
                        })}
                    </View>
