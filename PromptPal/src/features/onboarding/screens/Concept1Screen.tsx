                    ...
                    <Animated.View entering={FadeInUp.duration(500).delay(400)} style={styles.textContainer}>
                        ...
                        <View style={styles.bulletPoints}>
                            <View style={styles.bulletRow}>
                                <Ionicons name="cube-outline" size={24} color={ONBOARDING_COLORS.info} />
                                <Text style={styles.bulletText}>Structure: The look and parts.</Text>
                            </View>
                            <View style={styles.bulletRow}>
                                <Ionicons name="flash-outline" size={24} color={ONBOARDING_COLORS.accent} />
                                <Text style={styles.bulletText}>Behavior: The action and result.</Text>
                            </View>
                        </View>

                        <View style={styles.exampleBox}>
                            <Text style={styles.exampleTitle}>Lesson Goal</Text>
                            <Text style={styles.exampleGood}>"Add a [shape] [color] button that [action] when clicked."</Text>
                        </View>
                    </Animated.View>
