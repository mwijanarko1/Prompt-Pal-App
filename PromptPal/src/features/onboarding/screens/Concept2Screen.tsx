				...
				<View style={styles.container}>
					...
					>
						...
						<Text style={styles.description}>
							Details help AI understand exactly how an interactive feature
							should work.
						</Text>
						...
						<View style={styles.bulletPoints}>
							...
							<View style={styles.bulletRow}>
								...
								/>
								<Text style={styles.bulletText}>
									Action: What triggers the logic?
								</Text>
							</View>
							<View style={styles.bulletRow}>
								<Ionicons
						...
						<View style={styles.exampleBox}>
							...
							<Text style={styles.exampleGood}>
								"Add a text input and an 'Add' button that appends new items to
								the list."
							</Text>
						</View>
					</Animated.View>
