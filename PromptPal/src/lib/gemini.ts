...
export class GeminiService {
  ...
  async generateImage(prompt: string): Promise<string> {
    ...
    console.log(`[Gemini] Generating image for prompt using ${model}:`, prompt);
  ...
  async compareImages(targetUrl: string, resultUrl: string, taskId?: string): Promise<number> {
    ...
    console.log(`[Gemini] Comparing images using ${model}:`, { targetUrl, resultUrl });
  ...
  async getPromptHints(prompt: string): Promise<string[]> {
    ...
    console.log(`[Gemini] Getting hints for prompt using ${model}:`, prompt);
