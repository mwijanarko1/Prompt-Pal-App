...
const COPY_IDS = [
  "copywriting-1-easy", "copywriting-2-easy", "copywriting-3-easy",
  "copywriting-4-medium", "copywriting-5-medium", "copywriting-6-medium", "copywriting-7-medium",
  "copywriting-8-hard", "copywriting-9-hard", "copywriting-10-hard",
  "copywriting-11-hard", "copywriting-12-hard", "copywriting-13-hard", "copywriting-14-hard", "copywriting-15-hard",
];
...
export const copywritingLessons = [
  {
    ...
    grading: {
      ...
      criteria: [
        {
          id: "not_generic",
          description: "The tagline could not apply to any other coffee brand. It is specific to this audience and tone.",
          method: "llm_judge",
          weight: 3,
          required: true,
        },
        {
          id: "no_banned_words",
          description: "The tagline contains none of the following: robust, bold, premium, artisan, crafted, seamless, innovative, transform.",
          method: "llm_judge",
          weight: 2,
          required: true,
        },
        {
          id: "matches_tone",
          description: "The tagline sounds raw and direct, not polished or corporate.",
          method: "llm_judge",
          weight: 1,
          required: false,
        },
    ...
    failState: {
      ...
      nudge: "That tagline could be for any coffee brand. What makes this one different? Who exactly is drinking it and why?",
    },
    successState: {
      condition: "Passing condition is met.",
      feedback: "That's specific enough to belong to one brand. Generic is AI's default. Specific is what you have to ask for.",
    },
    lessonTakeaway:
  ...
  },
  {
    ...
    starterContext: {
      brand: "Glow Theory",
      audience: "Women in their late 20s and 30s who are done with overcomplicated routines",
      personality:
    ...
    starterContext: {
      ...
      channels: [
        ...
        },
        {
          ...
          rules: "Under 30 characters, action-oriented, no punctuation at the end",
        },
        {
